...
if __name__ == '__main__':
    ...
    prediction_model.load_weights(config.MODEL_WEIGHTS_PATH)

    boxes, scores, labels = model.predict(val_dataset)
    ...
    precisions = []
    for val_boxes, pred_boxes in zip(val_image_bboxes, boxes):
