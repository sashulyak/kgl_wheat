...
from kgl_wheat.efficientdet.efficientnet import EfficientNetB4, preprocess_input
from kgl_wheat.efficientdet.layers import ClipBoxes, RegressBoxes, FilterDetections, wBiFPNAdd
...
def efficientdet(num_classes=20, num_anchors=9, weighted_bifpn=False, freeze_bn=False,
                 score_threshold=0.01, detect_quadrangle=False, anchor_parameters=None, separable_conv=True,
                 finetuned_num_classes=None):
    input_size = 1024
